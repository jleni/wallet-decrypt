...
_TRANSACTIONCONFIDENCE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IN_CONFLICT', index=5, number=5,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_TRANSACTION_PURPOSE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RAISE_FEE', index=6, number=6,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_DETERMINISTICKEY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sigsRequiredToSpend', full_name='wallet.DeterministicKey.sigsRequiredToSpend', index=5,
...
_TRANSACTIONCONFIDENCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='last_broadcasted_at', full_name='wallet.TransactionConfidence.last_broadcasted_at', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source', full_name='wallet.TransactionConfidence.source', index=6,
